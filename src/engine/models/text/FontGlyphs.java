...
public class FontGlyphs {
	...
	private static Map<String, FontGlyphs> s_FontGlyphs = new HashMap<>();

	public static FontGlyphs common() {
		if (!s_FontGlyphs.containsKey(Font.SANS_SERIF)) {
			s_FontGlyphs.put(Font.SANS_SERIF, new FontGlyphs(Font.SANS_SERIF, Font.PLAIN, 16));
		}
		return s_FontGlyphs.get(Font.SANS_SERIF);
	}
	...
	public FontGlyphs(String name, int style, int size) {
