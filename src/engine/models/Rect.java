...
import engine.models.text.Text;
...
public class Rect implements Stringable, Renderable {
	...
	public Rect(Vector2f horizontalBounds, Vector2f verticalBounds) {
		this.m_Material = Material.material("default2D").clone(MathTools.randomFilename());
	...
	public Texture render(Object... args) {
		...
		shader.stop();
		GuiRenderer.s_TL.unbind();

		if (m_Text != null) m_Text.render(resolution, model, this);			
